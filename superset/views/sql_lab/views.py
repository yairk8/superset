...
class TabStateView(BaseSupersetView):
    ...
    def post(self) -> FlaskResponse:
        try:
            ...
            return json_error_response(__("Error creating tab state"), 400)
    ...
    def delete(self, tab_state_id: int) -> FlaskResponse:
        try:
            ...
            return json_error_response(__("Error deleting tab state"), 400)
    ...
    def activate(self, tab_state_id: int) -> FlaskResponse:
        try:
            ...
            return json_error_response(__("Error activating tab state"), 400)
    ...
    def put(self, tab_state_id: int) -> FlaskResponse:
        ...
        try:
            ...
            return json_error_response(__("Error updating tab state"), 400)
    ...
    def migrate_query(self, tab_state_id: int) -> FlaskResponse:
        try:
            ...
            return json_error_response(__("Error migrating query"), 400)
    ...
    def delete_query(self, tab_state_id: int, client_id: str) -> FlaskResponse:
        try:
            ...
            db.session.rollback()
            logger.exception("Error deleting query %s", client_id)
            return json_error_response(__("Error deleting query"), 400)
...
class TableSchemaView(BaseSupersetView):
    ...
    def post(self) -> FlaskResponse:
        try:
            ...
            return json_error_response(__("Error creating table schema"), 400)
    ...
    def delete(self, table_schema_id: int) -> FlaskResponse:
        try:
            ...
            return json_error_response(__("Error deleting table schema"), 400)
    ...
    def expanded(self, table_schema_id: int) -> FlaskResponse:
        try:
            ...
            return json_error_response(__("Error updating table schema"), 400)
